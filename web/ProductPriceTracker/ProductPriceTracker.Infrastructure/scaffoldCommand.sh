...
dotnet ef dbcontext scaffold "Server=localhost;Database=ScrapeDb;User Id=sa;Password=!QAZ@WSX123;TrustServerCertificate=True" Microsoft.EntityFrameworkCore.SqlServer --output-dir ../ProductPriceTracker.Core/Entities --context ScrapeDbContext --context-dir Data --startup-project ../ProductPriceTracker.Api --no-onconfiguring --force
